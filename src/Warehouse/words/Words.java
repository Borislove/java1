...
public class Words extends JFrame {
    ...
    private static Words game_window;
...
//if (drop_top > game_window.getHeight())
    ...
    public static void main(String[] args) throws IOException {
        ...
        background = ImageIO.read(Words.class.getResourceAsStream("background.png"));
        game_over = ImageIO.read(Words.class.getResourceAsStream("game_over.png"));
        drop = ImageIO.read(Words.class.getResourceAsStream("drop.png"));

        game_window = new Words();
