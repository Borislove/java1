package ru.progwards.java1_1.java1.lessons.basics;
...
//v2  Геттеры и константы
    private static final double PI_DOUBLE = 3.14;
    private static final float PI_FLOAT = 3.14f;  //можно внутри функции

    private static double getPiDouble() {
        return PI_DOUBLE;
    }

    private static float getPiFloat() {
        return PI_FLOAT;
    }
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public static double volumeBallDouble(double radius) {
        return (double) 4 / 3 * getPiDouble() * radius * radius * radius;   //  (double) 1.082759741481069E12
    }
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public static float volumeBallFloat(float radius) {
        return (float) 4 / 3 * getPiFloat() * radius * radius * radius; //  1.08275990528E12
    }
