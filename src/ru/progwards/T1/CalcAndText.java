...
/*Создайте класс с именем CalcAndText в котором разместите функцию main, которая выводит информацию на консоль, используя сложение чисел и строк, следующую информацию
